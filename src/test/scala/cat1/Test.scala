...
object Test {
  ...
  val arrow1: Int => Char = i => i.toChar

  val arrow2: Char => String = c => c.toString * 3

  val arrow1_2: Int => String = Set.compose(arrow2, arrow1)
  ...
  val arrow3: A => B = a => new B

  val arrow4: B => C = b => new C

  val arrow3_4: A => C = Set.compose(arrow4, arrow3)
